    ...
    return (
        ...
        <div id="aboutus-section">
            <div className='mx-auto max-w-7xl px-4 py-24 my-32 lg:px-10 bg-lightgrey rounded-3xl relative'>
                <Image src={`${getImagePrefix()}images/aboutus/dots.svg`} width={100} height={100} alt="dots-image" className="absolute bottom-1 -left-20" />
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 my-16 gap-x-16 lg:gap-x-32'>
                    {Aboutdata.map((item, i) => (
                        <div key={i} className='hover:bg-navyblue bg-white rounded-3xl mt-16 pt-10 pl-8 pb-10 pr-6 shadow-xl group'>
                            ...
                            <Image src={`${getImagePrefix()}${item.imgSrc}`} alt={item.imgSrc} width={100} height={100} className="mb-5" />
