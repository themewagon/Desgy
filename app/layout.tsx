...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'The Prism Lab' }],
  creator: 'The Prism Lab',
  publisher: 'The Prism Lab',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  },
  metadataBase: new URL('https://theprismlab.com'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'The Prism Lab - AI Training, Strategy & Execution for SMBs',
      },
    ],
    locale: 'en_US',
    type: 'website',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "sameAs": ["https://linkedin.com/company/theprismlab"]
            })
          }}
        />
        <script
